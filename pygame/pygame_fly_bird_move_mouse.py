...
player_image = pygame.image.load(r'C:\Users\Asus\Desktop\IT DEVELOPER\Python\Python Core\9 (09.09.20) о 17.00\twitter.png').convert()
...
# для того, щоб картинка стара зникала, тобто щоб не було сліду від неї
# потрібно додати цей рядок, що нижче
